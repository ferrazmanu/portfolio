...
export const PROJECTS_DATA = [
  {
    ...
    stack: ["HTML", "CSS", "JavaScript", "Google Analytics 4", "Google Tag Manager"],
    date: {
  ...
  },
  {
    ...
    stack: ["React", "TypeScript", "Material UI", "React Hook Form", "Axios", "GraphQL", "Redux"],
    date: {
  ...
  },
  {
    ...
    stack: ["Next.js", "React", "TypeScript", "GraphQL", "Redux Toolkit", "Swiper"],
    date: {
  ...
  },
  {
    ...
    stack: ["Next.js", "React", "TypeScript", "GraphQL", "Apollo Client", "Swiper", "Day.js"],
    date: {
      pt: "2023 - Projeto Freelancer",
      en: "2023 - Freelance Project",
    },
